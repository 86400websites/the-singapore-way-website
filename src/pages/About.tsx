        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="overflow-hidden rounded-2xl shadow-[0_24px_48px_-24px_rgba(17,17,17,0.18)] w-full max-w-[420px] aspect-[4/5]">
                <img
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            <div className="card-editorial p-8 md:p-10">
              <img src="/assets/about/mission-icon.png" alt="" className="h-12 w-auto mb-6 opacity-80" />
            ...
            <div className="card-editorial p-8 md:p-10">
              <img src="/assets/about/vision-icon.png" alt="" className="h-12 w-auto mb-6 opacity-80" />
              <h3 className="text-xl md:text-2xl font-bold text-[#111111] leading-[1.25] mb-4">
                Our Vision
              </h3>
              <p className="prose-body">
