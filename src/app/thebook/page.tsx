...
export const metadata: Metadata = pageMetadata({
  title: 'The Book',
  description:
    'More than a theory — a practical toolkit for change. Seventeen chapters on how Singapore built scalable systems in housing, water, education, and governance.',
  path: '/thebook',
})
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <FreeBookSummaryButton showIcon />
