...
> The single holding pen for everything that is not the current sprint. Copy once per project and keep it living — this file mirrors the Post-Launch Backlog sheet in the Development Operating Room workbook.
...
- [ ] Security hardening deferrals (rate limiting, CAPTCHA, etc.) are marked **required-before-scale**, not optional.
